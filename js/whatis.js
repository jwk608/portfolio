...
$(document).ready(function () {
    ...
    toggleMenuButton.add(scrollTopButton).on("mouseenter", function () {
        scrollTopButton.addClass("is-visible").css("left", $(window).outerWidth() - logo.offset().left - 113 + "px")
    });
    toggleMenuButton.add(scrollTopButton).on("mouseleave", function () {
        scrollTopButton.removeClass("is-visible").css("left", $(window).outerWidth() - logo.offset().left - 60 + "px")
    });
